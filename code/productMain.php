                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item" style="text-align:center;">
                            ...
                            $image1 = "$row[image1]";
                            $image2 = "$row[image2]";
                            echo "<img class=\"product__details\"
                                src=\"$image1\" width=\"430\" height=\"600\" style=\"min-width:0;\">
                        </div>
                    </div>
                </div>
                <div class=\"col-lg-6 col-md-6\">
                    <div class=\"product__details__text\">
                        <h3>$row[name]</h3>
                        <div class=\"product__details__price\">$$row[price].00</div>
                        <p>$row[content]</p>
                        <div class=\"product__details__quantity\">
                            <div class=\"quantity\">
                                <div class=\"pro-qty\">
                                    <input type=\"text\" value=\"$row[count]\" readonly>
                                    <a style=\"margin-left: 1vw;\" data-bs-toggle=\"offcanvas\" role=\"button\" aria-controls=\"userCart\"><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"30\" height=\"30\" fill=\"#4F6D7A\" class=\"bi bi-heart\" viewBox=\"0 0 16 16\">
                        ...
                        <ul>
                            <li><b>SIZE<samp>(平量尺寸)</samp></b> <span>F</span></li>
                            <li><b>衣長</b> <span>$row[length]cm</span></li>
                            <li><b>肩寬</b> <span>$row[shoulder_width]cm</span>
                            <li><b>胸寬</b> <span>$row[chest_width]cm</span></li>";
                            ?>
                            <li><b>Share on</b>
                                <div class="share">
                            ...
                            <div class="tab-pane active" id="tabs-1" role="tabpanel">
                                <div class="product__details__tab__desc">
                                    ...
                                    <p>Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui.
                                        ...
                                        <img class=\"product\" src=\"$image1\" width=\"600\" height=\"880\">
                                        <img class=\"product\" src=\"$image2\" width=\"600\" height=\"880\"></div>";
                                    }?>
                                </div>
                            </div>
